      ...
      <main className="max-w-5xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-8 space-y-4 sm:space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Add New Drink</h1>
              <p className="text-sm text-gray-600">Create a new beverage item for the menu</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-4 sm:p-6 space-y-6">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-2xl p-6 bg-gray-50 hover:border-blue-400 transition">
                {imagePreview ? (
                  ...
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">Upload a clear product photo</p>
                    </div>
                    <button
                      onClick={openPicker}
                      type="button"
                      className="inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-5 py-3 rounded-xl hover:bg-blue-700 transition text-sm font-medium shadow-lg shadow-blue-200"
                    >
                      <Upload className="w-4 h-4" />
          ...
          <div className="border-t border-gray-200 p-4 sm:p-6 bg-gray-50 space-y-3">
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              <button
                ...
                disabled={submitting}
                className="flex-1 inline-flex items-center justify-center gap-2 bg-blue-600 text-white px-5 py-3 rounded-xl hover:bg-blue-700 transition text-sm font-semibold disabled:opacity-60 disabled:cursor-not-allowed shadow-lg shadow-blue-200"
              >
                {submitting ? (
                  <>
                    <Loader2 className="w-4 h-4 animate-spin" />
